...
const TECH_STACK = ["Python", "React", "TailwindCSS", "Node.js", "MongoDB", "HTML", "CSS", "Javascript", "Machine learning", "AI", "GitHub"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/2subhadeep" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/subhadeep-paul-b45336246/" },
  { icon: Instagram, link: "https://www.instagram.com/itz.subhadeep111/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Passionate about crafting impactful web solutions, I thrive on challenges and continuous growth.
                </p>
