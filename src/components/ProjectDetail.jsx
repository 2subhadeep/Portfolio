...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private') {
    Swal.fire({
      ...
      text: 'Apologies, the source code for this project is private and cannot be shared.',
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...selectedProject,
        Features: selectedProject.Feature || [],
        TechStack: selectedProject.Techstack || [],
        Github: selectedProject.Github || 'https://github.com/2subhadeep',
      };
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              ...
              <span className="text-white/90 truncate">{project.Tittle}</span>
            </div>
          </div>
